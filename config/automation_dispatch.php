...
return [
    ...
    'email' => [
        'default_subject' => env('AUTOMATION_EMAIL_SUBJECT', 'Mensagem Grade'),
        'default_message' => env('AUTOMATION_EMAIL_MESSAGE', 'Olá {nome}, esta é uma mensagem automática da Grade.'),
    ],

    'sms' => [
        'webhook_url' => env('AUTOMATION_SMS_WEBHOOK_URL', ''),
        'timeout_seconds' => env('AUTOMATION_SMS_TIMEOUT', 10),
        'default_message' => env('AUTOMATION_SMS_MESSAGE', 'Olá {nome}, mensagem automática da Grade.'),
    ...
    'whatsapp' => [
        ...
        'default_message' => env('AUTOMATION_WHATSAPP_MESSAGE', 'Olá {nome}, mensagem automática da Grade.'),
